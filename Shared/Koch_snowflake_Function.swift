...
/// makeline
///
/// Calculates the next vertex in the Koch snowflake Fractal
///
/// - Parameters:
...
/// turn
///
/// Calculates the turn angle in the Koch snowflake Fractal to get the next point
///
...
/// Koch snowflakeFractalCalculator
///
/// Calculates the 4 sided Koch snowflake Fractal
///
/// - Parameters:
...
/// - Returns: array of x and y points for all of the vertices in the Koch snowflake Fractal. Used to make the path for the view
///
